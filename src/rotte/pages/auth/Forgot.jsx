    ...
    if (sent) {
        return (
            <div style={{ textAlign: "center" }}>
                ...
                <Link to="/auth/login" style={{ display: "block", textAlign: "center", fontSize: 13, color: "#AAA", textDecoration: "none" }}>
        ...
        <div>
            <div style={{ textAlign: "center", marginBottom: 26 }}>
                <div style={{ width: 52, height: 52, borderRadius: 14, background: MAROON_MUTED, display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 14px" }}>
                    <Mail size={24} style={{ color: MAROON }} />
                </div>
            ...
            <form onSubmit={handleSubmit}>
                <div style={{ marginBottom: 20 }}>
                    ...
                    <div style={{ position: "relative" }}>
                        <Mail size={16} style={{ position: "absolute", left: 12, top: "50%", transform: "translateY(-50%)", color: "#CCC" }} />
                ...
                <button type="submit" disabled={loading}
                    style={{ width: "100%", background: loading ? "#CCC" : MAROON, color: "#fff", border: "none", borderRadius: 10, padding: 13, fontSize: 14, fontWeight: 700, cursor: loading ? "not-allowed" : "pointer", transition: "background 0.2s", marginBottom: 16, display: "flex", alignItems: "center", justifyContent: "center", gap: 6 }}
            ...
            <Link to="/auth/login" style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 6, fontSize: 13, color: "#AAA", textDecoration: "none" }}>
                <ArrowLeft size={11} /> Kembali ke halaman login
            </Link>
